...
const OPTIONS = {
  size: [
    { value: 'robusto', price: 10, image: '/public/images/Robusto.png' },
    { value: 'gordo', price: 12,image: '/public/images/Robusto.png' },
    { value: 'churchill', price: 14 },
    { value: 'belicoso', price: 14 }
  ],
  binder: [
    { value: 'habano', price: 0 },
    { value: 'maduro', price: 1 },
    { value: 'connecticut', price: 0.5 }
  ],
  flavor: [
    { value: 'light', price: 0 },
    { value: 'medium', price: 2 },
    { value: 'strong', price: 2 }
  ],
  bandStyle: [
    { value: 'beveled', price: 2 },
    { value: 'round', price: 2 },
    { value: 'dome', price: 2 },
    { value: 'square', price: 2 }
  ],
  box: [
    { value: 'classic', price: 20 },
    { value: 'rustic', price: 18 },
    { value: 'modern', price: 24 }
  ]
};
            ...
            <div style={{
              ...
              {!previewUrl ? (
                ...
                <div>
                  ...
                  />
                  <button
                    onClick={() => setPreviewUrl('http://localhost:5000/api/render-preview')}
                    style={{
